...
| ----- | ---- | ----- | ------ |
| 1 | 0:00 - 0:@@ | Kaseem is deaf and legally blind with partial vision. At home she has a large screen and she uses a software that magnifies the content. | Kaseem is sitting in front of her computer setup. We see the large screen with very large text. She browses around the page and leans in to read passages of text, then browses around again to find a button elsewhere on the page and press it. |
