...
| 4 | 0:30 - 0:38 | Some websites do not provide such indicators. Nothing changes on his screen when he presses the tab key, and does not know where the current focus is on the page. | Same scene with another website with no focus indicator. Alex looks confused/lost then dismayed/frustrated (he is tapping the tab key but not seeing the indicator on the screen). |
