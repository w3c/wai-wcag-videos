...
| 5 | @:@@ - @:@@ | This newspaper app only works in portrait orientation, so Jan can not use it while he's on the road. | We see the screen mounted in landscape orientation with the text in a newspaper app appearing in portrait (sideways for him). |
