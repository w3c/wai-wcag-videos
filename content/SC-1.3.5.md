...
| ----- | ---- | ----- | ------ |
| 1 | 0:00 - 0:@@ | Preety is a middle school student with dyslexia and dyscalculia, which makes it difficult for her to type things like phone number, email address, username, and password. | We see Preety reading on a tablet computer at her desk at home (see [SC-1.3.2](https://wai-wcag-videos.netlify.app/sc-1.3.2/)). |
| 2 | 0:@@ - @:@@ | For example, she often has difficulty logging into the school's online learning platform. It is not a memory issue but she just confuses the numbers and letters when she is typing them because they are not real words. | We see a form asking for "Student ID" and "Password", and she seems to have trouble typing in the long Student ID number. |
