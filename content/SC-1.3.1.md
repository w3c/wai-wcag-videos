...
| 4 | @:@@ - @:@@ | Sometimes developers do not use the correct mark-up, and the structure becomes unclear. For example, this text looks like a heading but is not coded as such, so it is not announced. [We hear the screen reader read text without announcing it as a heading] | We see a similar heading to the one shown earlier; it is highlighted by the screen reader as it is being read aloud (but this time it is not announced as a heading). |
